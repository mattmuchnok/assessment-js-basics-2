...
// console.log(canWeDeliver(16059))
...
// console.log(canWeDeliverTwo(85206)) // You're in our delivery zone!
// console.log(canWeDeliverTwo(16059)) // Sorry, we can't deliver to that address
