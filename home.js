...
// canWeDeliverTwo(85206) // You're in our delivery zone!
// canWeDeliverTwo(16059) // Sorry, we can't deliver to that address
...
//CODE HERE
let result2 = deals[1].desc.trim().replace(`March`, `April`)
// console.log(result2)